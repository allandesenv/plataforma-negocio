package com.plataformanegocios.sufix.authservice.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                // Logar erro de parsing ou token inválido
                System.err.println("Erro ao extrair username do JWT: " + e.getMessage());
            }
        }

        // Se o username foi extraído e não há autenticação no contexto de segurança
